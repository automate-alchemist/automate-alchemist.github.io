...
rating: 5
cover_image: '/images/lessons-in-chemistry.jpg'
---

<div class="book-meta" style="margin-bottom: 20px; color: #666;">
By {{ page.book_author }} • Published {{ page.publication_year }} • {{ page.reading_time }} read • ⭐⭐⭐⭐⭐
</div>

<div class="book-container" style="display: grid; grid-template-columns: 2fr 1fr; gap: 30px; margin: 20px 0;">
...
<div class="book-cover" style="text-align: right;">
<img src="{{ page.cover_image }}" alt="{{ page.title }}" style="max-width: 100%; height: auto; box-shadow: 0 4px 8px rgba(0,0,0,0.1); border-radius: 4px;">
</div>
...
<span style="display: inline-block; padding: 5px 10px; background: #f5f5f5; border-radius: 15px; margin-right: 10px; font-size: 0.9em; color: #666;">{{ tag }}</span>
{% endfor %}
</div>